...
public class Serial implements SerialPortEventListener {
    ...
    private StringBuilder serialStringBuffer = new StringBuilder(1048576);
    ...
    private Serial(String iname, int irate, char iparity, int idatabits, float istopbits) throws SerialException {
        ...
        try {
            ...
            if (!res) {
                System.err.println(I18n.format(I18n.tr("Error while setting serial port parameters: {0} {1} {2} {3}"),
    ...
    protected void message(char[] chars, int length) {
        ...
        serialStringBuffer.append(chars, 0, length);
    }

    public String consumeStringBuffer() {

        String string = serialStringBuffer.toString();
        serialStringBuffer.setLength(0);
        return string;
    }
